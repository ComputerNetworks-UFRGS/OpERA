...
class RPCBaseProxy(object):
    ...
    def _proxy_class_methods(self, instance):
        ...
        """
        methods =  [(name, func) for name, func in inspect.getmembers(instance, predicate=inspect.ismethod) if name is not '__init__' ]
...
class RPCExporter(Thread, RPCBaseProxy):
    ...
    def _imp_proxy_method(self, name, func):
        """
        Implemetation of base class abstract method.
