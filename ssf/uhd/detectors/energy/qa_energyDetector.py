...
from energyDetector         import energy_detector_c, EDTopBlock
from device                 import UHDDevice
from ssf.algorithm.sensing  import EnergyAlgorithm

import numpy as np


## QA related to EnergyDetector class.
class qa_energy_detector(gr_unittest.TestCase):
	...
	def test_001(self):
		...
		src = gr.vector_source_c(data = src_data)
		ed = energy_detector_c(fft_size, mavg_size, EnergyAlgorithm(1) )
