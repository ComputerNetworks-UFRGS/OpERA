...
#::TODO:: descobrir pq o val continua por aqui...
...
def transmission_res_func(who, val):
    ...
    if dev1 in globs.tx_links and globs.tx_links[dev1][1] == OPERATIONS['tx']:
        ...
        globs.gen_reward_matrix[dev1][ch_used] += globs.gen_reward_matrix[dev1][ch_used] * 0.75 + (
        float(pkt_rec) / pkt_send) * 0.25
