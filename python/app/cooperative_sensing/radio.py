...
from sensing import EnergyDecision             #pylint: disable=F0401
from device import UHDSource, UHDSink          #pylint: disable=F0401
from device import RadioDevice                 #pylint: disable=F0401
from packet import PacketGMSKRx, PacketGMSKTx  #pylint: disable=F0401
from sensing import EnergySSArch               #pylint: disable=F0401
...
def callback_radio(radio):
    ...
    def command(payload):
        ...
        exec_cmd = {"set_channel": radio.set_channel,
...
#::TODO:: pq radio nao é usado? pq cur_channel nao estava na lista de parametros?
