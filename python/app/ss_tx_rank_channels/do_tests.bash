...
function startBoth()
{
	...
	./ss_rank_tx.py --interferer --args addr=$DEV1_IP --log --mode $MODE --samp-rate $SAMP_RATE --duration $DURATION --pkt-size $PKT_SIZE --platform $PLATFORM --iteration $ITERATION --sending-duration $SENDING_DUR --sensing-duration $SENSING_DUR &

	sleep 3
	./ss_rank_tx.py --args addr=$DEV2_IP --log --mode $MODE --samp-rate $SAMP_RATE --duration $DURATION --pkt-size $PKT_SIZE --platform $PLATFORM --iteration $ITERATION --sending-duration $SENDING_DUR --sensing-duration $SENSING_DUR
	sleep 10
	killall Python
	killall python
}
