...
class top_block(gr.top_block):
    ...
    def __init__(self, options):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "./%d_%d_%d_%d_noise.bin" % (fft_len, cp_len, options.ebn0, options.it), False)
        ...
        self.connect((self.digital_ofdm_mod_0, 0), (self.blocks_add_xx_0, 0))
