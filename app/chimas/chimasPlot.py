...
{bottom_extra}
""".format( outfile = outfile, ylabel = ylabel, column = col, f = filenames, extra = extra, bottom_extra = bottom_extra, subscript = subscript, channels = channels)
