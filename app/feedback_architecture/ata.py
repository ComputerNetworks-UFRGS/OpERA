...
from algorithm.decision import EnergyDecision, WaveformDecision, BayesLearningThreshold, SARSA, CycloDecision
from gr_blocks.sensing  import EnergySSArch2,  WaveformSSArch2, FeedbackSSArch2, CycloSSArch
...
class OpERAUtils(object):
    ...
    def device_definition(options):
        ...
        if options.sensing == "waveform":
            feedback = FeedbackSSArch2(
                    learning_algorithm = bl_algo,
        ...
        #radio.add_arch(source = the_source, arch = waveform, sink = blocks.probe_signal_vf(1024), uhd_device = uhd_source, name = 'feedback')
