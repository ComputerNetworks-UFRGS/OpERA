...
plot '{infile1}' using (8*${col}*$2/1000000/60) t 'TX Only' w linespoints,  '{infile2}' using (8*${col}*$2/1000000/60) t 'SS 0.1s' w linespoints, '{infile3}' using (8*${col}*$2/1000000/60) t 'SS 0.5s' w linespoints, '{infile4}' using (8*${col}*$2/1000000/60) t 'SS 1.0s' w linespoints
	...
	tx_script = gnuplot_script.format( outfile = PLOT1_LNAME + '_tx_bytes.pdf', infile1 = PLOT1_LFILES[0], infile2 = PLOT1_LFILES[1], infile3 = PLOT1_LFILES[2], infile4 = PLOT1_LFILES[3], col = '3')
	rx_script = gnuplot_script.format( outfile = PLOT1_LNAME + '_rx_bytes.pdf', infile1 = PLOT1_LFILES[0], infile2 = PLOT1_LFILES[1], infile3 = PLOT1_LFILES[2], infile4 = PLOT1_LFILES[3], col = '4')
...
plot '{infile1}' using (8*${col}*$2/1000000/60) t '2.70 GHz Core i5' linecolor rgb "#2e75b5",  '{infile2}' using (8*${col}*$2/1000000/60) t '2.33 GHz C2D E6550' linecolor rgb "#deebf6",  '{infile3}' using (8*${col}*$2/1000000/60) t '2.8 GHz Pentium 4' linecolor rgb "#bfbfbf"
	...
	tx_script = gnuplot_script.format(outfile = OUTPUT_NAME + '_tx_bytes.pdf', infile1 = INPUT_NAME[0], infile2 = INPUT_NAME[1], infile3 = INPUT_NAME[2], col = '3')
	rx_script = gnuplot_script.format(outfile = OUTPUT_NAME + '_rx_bytes.pdf', infile1 = INPUT_NAME[0], infile2 = INPUT_NAME[1], infile3 = INPUT_NAME[2], col = '4')
...
def parse_proc(options):
	...
	with open(outfile, 'w+') as fd:
		...
		fd.write('id block_name avg_cicles per_cicles type\n')

		for key in tx_data:
			fd.write("\"%s\" \"%s\" %f %f tx\n" % (mapper_txt[mapper_id[key]], key, tx_data[key]/tx_count[key], tx_data[key]/tx_total_cicles*100.0))
		for key in rx_data:
			fd.write("\"%s\" \"%s\" %f %f rx\n" % (mapper_txt[mapper_id[key]], key, rx_data[key]/rx_count[key], rx_data[key]/rx_total_cicles*100.0))
