...
from gr_blocks.sensing import EnergyDetectorC
from gr_blocks.sensing import WaveformDetectorC 
from gr_blocks.sensing import FeedbackSSArch
...
## Realiza a deteccao usando somente o detector de energia, com um limiar perfeito.
#
def ideal(options):
